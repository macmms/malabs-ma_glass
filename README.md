...
6. [Running][head0600]  
  6.1 [Work Orders][head0601]  
  6.2 [Scheduled Maintenance][head0602]  
  6.3 [Scan QR Code][head0603]  
  6.4 [Generate Asset][head0604]  
  6.5 [View More][head0605]  
  6.6 [See Tasks][head0606]  
  6.7 [Change Status ][head0607]  
  6.8 [Generate Work Order][head0608]  
...
[scanning a QR code][head0603]. From these cards, there are four options:  
* [View More][head0605]
* [Related Work Orders][head0601]
* [Related Scheduled Maintenance][head0602]
* [Generate Work Order][head0608]
...
There are no further options from Change Status. By tapping the Google Glass
touchpad once, the status currently on the screen will be selected, and the work
order which was viewed at the time of selecting the Change Status option will
have its status switched to the chosen option.
...
[head0600]: #6-running
[head0601]: #6.1-work-orders
[head0602]: #6.2-scheduled-maintenance
[head0603]: #6.3-scan-qr-code
[head0604]: #6.4-generate-asset
[head0605]: #6.5-view-more
[head0606]: #6.6-see-tasks
[head0607]: #6.7-change-status
[head0608]: #6.8-generate-work-order
